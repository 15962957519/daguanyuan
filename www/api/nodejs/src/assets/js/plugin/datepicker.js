    ...
    $.fn.datePicker = function(options) {
        return this.each(function(e) {
            ...
            function  rimDetect(result, rim) {
                ...
                if (getYear(opts.currentValue) == rimDate.getFullYear()) {
                    ...
                    if (('0' +getMonth(opts.currentValue)).slice(-2)  == ('0' +(rimDate.getMonth() + 1)).slice(-2)) {
                        ...
                        console.log(getDate(opts.currentValue))
                        console.log(rimDate.getDate())
            ...
            function init() { //初始化函数
                ...
                rimDetect(result, 'start')
                rimDetect(result, 'end')
            ...
            function renderDom() {
                ...
                timeHtml += '</div>';
                var monthHtml = '<div  style="display:none" class="d-date-wrap">';
            ...
            function createDay(dayNum) {
                var dayDom = $('#dayScroll'),
                    dayHtml = '<li></li>';
                let startmonth =Number(result.date[0]);
                let endmonth =Number(result.date[1]);
                for (var i = startmonth; i <= endmonth; i++) {
                    if (i < 10) {
            ...
            function createHour() {
                ...
                let startday =Number(result.date[0]);
                let endday =Number(result.date[1]);

                let startmonth =Number(result.hour[0]);
                let endmonth =Number(result.hour[1]);



                if(startday == endday && startmonth >0 && endmonth>startmonth){
                    for (var i = startmonth; i <= endmonth; i++) {
                        if (i < 10) {
