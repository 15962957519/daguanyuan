                ...
                <div class="saleInfo icon_lists">
                    ...
                    <div class="createTime freePost">
                        ...
                        <template  v-for="(item,index) in items.nowaterimg" >
                             <div   v-if="(index==0)"  :img="item.img" :saleid="items.goods_id"  @click="share(items.goods_name,item.img,{name:'cacse',params:{goods_id:items.goods_id}},$event)" class="shareIt">分享</div>
                        </template>
    ...
    data: function() {
        ...
        sharetofriend(title,url,image,e){
            ...
            fetchData: function (progress,uid,type,page,goods_id) {
                       ...
                       axios.get('/product/indexpaimaiprolistcase?page='+page, {
            ...
            share:function(title,img,obj,e){
                ...
                let linkgurl=      default_domain_web+'/'+obj.name+'/'+obj.params.goods_id
