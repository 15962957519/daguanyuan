...
#foucsme .myfriend .detail{
height:70px;
float:left;
margin-top:9px;
}
#foucsme .myfriend .detail .nickname{
width:100%;
height:25px;
line-height:25px;
font-size:15px;
...
#foucsme .myfriend .detail .nickname .level{
position: absolute;
left: 0;
width: 28px;
margin-top: 5px;
...
#foucsme .myfriend .detail .nickname .level.v1{
    background-position: -10px -7px;
}
#foucsme .myfriend .detail .nickname .level.v2{
    background-position: -10px -37px;
}
#foucsme .myfriend .detail .nickname .level.v3{
    background-position: -10px -67px;
}
#foucsme .myfriend .detail .nickname .level.v4{
    background-position: -10px -97px;
}
#foucsme .myfriend .detail .nickname .level.v5{
    background-position: -10px -126px;
}
#foucsme .myfriend .detail .nickname .level.v6{
    background-position: -10px -156px;
}
#foucsme .myfriend .detail .nickname .level.v7{
    background-position: -10px -185px;
}

#foucsme .myfriend  .signature{
    height:35px;
    width:100px;
...
#foucsme .myfriend  .detailaction .status{
width:70px;
height:20px;
line-height:20px;
...
#foucsme .myfriend  .detailaction .status.nofocus{
background-image: url(../../assets/img/unfollow.png?t=4);
}
#foucsme .myfriend  .detailaction .status.focus{
background-image: url(../../assets/img/follow.png?t=4);
}
</style>
<template>
    <div>
    <div id="foucsme" v-infinite-scroll="loadMore" infinite-scroll-disabled="busy"  infinite-scroll-distance="10">
            <div class="myfriend border horizonBottom" v-for="item in lists" >
              <a href="javascript:;">
                <div class="avatar" v-bind:style="{ backgroundImage: 'url(' + item.head_pic + ')' }"></div>
              </a>
                <div class="detail">
                    <div class="nickname">
                ...
                <template v-if="item.t2fid ==item.user_id">
                    <div  class="detailaction">
                           <div @click.stop="unfocus(item.fans_id,$event)" class="status nofocus"></div>
                     </div>
                </template>
                <template v-else>
                    <div   class="detailaction">
                           <div @click.stop="focus(item.fans_id,$event)" class="status focus"></div>
                     </div>
                  </template>
            </div>
    </div>
