...
<div class="menuList individual">
            ...
            <a href="/myVerify/verifyInfo/operator/individual">企业信息</a>        </div>
  ...
  <div id="contentbox">
      ...
      <form id="shimingrenzheng" >
          <div class="verifyBox operator">
              <div class="title">
                  企业认证
                  <span>(请上传真实的企业信息，认证通过后将无法修改)</span>

              </div>
              <div class="infoItem text border horizonBottom">
                  <div class="liHead">企业名称</div>
                  <div class="liContent">
                      <input type="text" class="input" name="company_name" placeholder="请输入企业（公司）名称"  v-model="userinfo.name">
                  </div>
                  <div class="liFoot"></div>
              </div>
              <div class="infoItem text border horizonBottom">
                <div class="liHead">法人姓名</div>
                <div class="liContent">
                    <input type="text" class="input" name="legal_person" placeholder="请输入企业（公司）法人"  v-model="userinfo.name">
                </div>
                <div class="liFoot"></div>
            </div>
              <div class="infoItem text border horizonBottom">
                  <div class="liHead">身份证</div>
                  <div class="liContent">
                      <input type="text" class="input" name="idcode" placeholder="请输入企业（公司）法人身份证号" maxlength="21" v-model="userinfo.idcode">
                  </div>
                  <div class="liFoot"></div>
              </div>
                 ...
                 <div  @click="uploadverifyIdCodeFront('/user/userverfityimgfront',$event)"  class="liContent" serverid="" v-bind:style="{backgroundImage:'url('+userinfo.verifyIdcodefront_remote+')'} ">
                                   <div  v-if="front" class="example">
                                    <div class="examplePhoto">
                                       ...
                                       <div  @click="uploadverifyIdCodeFront('/user/userverfityimgfront',$event)" class="button">点击上传营业执照</div>
                                    <p>照片必须清晰哟！</p>
                                   </div>
    ...
    export default {
        data(){
                return {
                        ...
                        businessLicense:'/static/img/businessLicense.png',
