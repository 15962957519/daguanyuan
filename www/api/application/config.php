...
return [
    ...
    // | 应用设置
    // +----------------------------------------------------------------------
    'domain' => 'http://api.fanghua.jiuxintangwenhua.com/',
    // 应用命名空间
    'app_namespace' => 'app',
    ...
    'default_domain' => 'http://w.sijiweipai.com',
    'default_domain_api' => 'http://api.fanghua.jiuxintangwenhua.com',
...
//    ],
    ...
    'db_config_tp_goods_collect' => [
        // 数据库类型
        'type' => 'mysql',
        // 数据库连接DSN配置
        'dsn' => '',
        // 服务器地址
        'hostname' => '10.29.185.185',
        // 数据库名
        'database' => 'TESTDB',
        // 数据库用户名
        'username' => 'root',
        ...
        'hostport' => '8066',
        // 数据库连接参数
        'params' => [\PDO::ATTR_EMULATE_PREPARES => true, \PDO::MYSQL_ATTR_USE_BUFFERED_QUERY => true,],
        // 数据库编码默认采用utf8
        'charset' => 'utf8',
        // 数据库表前缀
        'prefix' => 'tp_',
    ...
    'mycat104' => [
        ...
        'sharejoin'=>'/*!mycat:catlet=io.mycat.catlets.ShareJoin */'
    ]
