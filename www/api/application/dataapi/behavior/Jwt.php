<?php
namespace app\dataapi\behavior;
...
class Jwt
{
    public function appInit(&$params)
    {
        ...
        $token = (new Builder())->setIssuer('http://w.sijiweipai.com') // Configures the issuer (iss claim)
        ->setAudience('http://w.sijiweipai.com') // Configures the audience (aud claim)
