...
use Think\Model;
class GoodsPrepareModel extends Model {
    ...
    protected $_validate = array(
        ...
        array('start_price','require','起步价必须填写！',1 ,'',3),
        array('every_add_price','require','每次加价必须填写！',1 ,'',3),
        array('goods_remark','require','商品区描述必须填写！',1 ,'',3),
