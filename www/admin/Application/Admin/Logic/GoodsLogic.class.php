...
class GoodsLogic extends RelationModel
{
    ...
    /**
     * 获取指定id下的 所有分类      
     * @global type $goods_category 所有商品区分类
     ...
     * @param int $goods_id 商品区id
     * @param int $type_id 商品区属性类型id
     */
    ...
    /**
     *  给指定商品区添加属性 或修改属性 更新到 tp_goods_attr
     * @param int $goods_id  商品区id
     * @param int $goods_type  商品区类型id
     */
    ...
    /**
     * 获取指定规格类型下面的所有规格  但不包括规格项 供商品区分类列表页帅选作用
     * @param type $type_id
     * @param type $checked
     */
    ...
    /**
     * 获取指定商品区类型下面的所有属性  供商品区分类列表页帅选作用
     * @param type $type_id
     * @param type $checked
     */
