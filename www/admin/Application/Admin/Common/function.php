...
function getAllMenu(){
	return	array(
			'system' => array('name'=>'系统设置','icon'=>'fa-cog','sub_menu'=>array(
                    ...
                    array('name'=>'虚拟链接','act'=>'virtual_bid','control'=>'System'),
			...
			'access' => array('name' => '权限管理', 'icon'=>'fa-gears', 'sub_menu' => array(
					...
					array('name' => '员工列表', 'act'=>'index', 'control'=>'CheckWorker'),
			)),
			'member' => array('name'=>'会员管理','icon'=>'fa-user','sub_menu'=>array(
					...
					array('name'=>'店铺等级','act'=>'index?store_level_id=1','control'=>'Store'),
			...
			'goods' => array('name' => '商品区管理', 'icon'=>'fa-book', 'sub_menu' => array(
					array('name' => '商品区分类', 'act'=>'categoryList', 'control'=>'Goods'),
					array('name' => '商品区列表', 'act'=>'goodsList', 'control'=>'Goods'),
					array('name' => '商品区类型', 'act'=>'goodsTypeList', 'control'=>'Goods'),
					array('name' => '商品区规格', 'act' =>'specList', 'control' => 'Goods'),
					array('name' => '商品区属性', 'act'=>'goodsAttributeList', 'control'=>'Goods'),
					array('name' => '品牌列表', 'act'=>'brandList', 'control'=>'Goods'),
					array('name' => '商品区评论','act'=>'index','control'=>'Comment'),
					array('name' => '商品区咨询','act'=>'ask_list','control'=>'Comment'),
                    array('name' => '首页商品区采集','act'=>'goodsCollect','control'=>'GoodsPrepare'),
                    //array('name' => '首页商品区上传','act'=>'goodsUpload','control'=>'GoodsPrepare'),
                    array('name' => '首页预备商品区','act'=>'goodsList','control'=>'GoodsPrepare'),
			)),
			'messages' => array('name' => '消息管理', 'icon'=>'fa-envelope', 'sub_menu' => array(
					array('name' => '信息反馈','act'=>'index','control'=>'Feedback'),
					array('name' => '粉丝列表','act'=>'index','control'=>'Fans'),
			)),
			...
			'promotion' => array('name' => '促销管理', 'icon'=>'fa-bell', 'sub_menu' => array(
                array('name' => '专场活动', 'act'=>'prom_goods_list', 'control'=>'Promotion'),
                ...
                array('name' => '转盘抽奖', 'act'=>'goodsList', 'control'=>'Lottery'),
			)),
...
/*
			'distribut' => array('name' => '分销管理', 'icon'=>'fa-cubes', 'sub_menu' => array(
					array('name' => '分销商品区列表', 'act'=>'goods_list', 'control'=>'Distribut'),
