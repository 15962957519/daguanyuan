...
return array(
   ...
   // 'DATA_CACHE_TYPE' =>  'File', 
    ...
    'HTML_CACHE_RULES'  =>     array(  // 定义静态缓存规则
        ...
        //ajax 请求的商品区列表内容在 ajaxGoodsList 函数中  S($keys,$html,300); 缓存
        'Goods:goodsInfo'=>array('{:module}_{:controller}_{:action}_{id}',TPSHOP_CACHE_TIME),  // 商品区详情页静态缓存 3秒钟                
        'Goods:ajaxComment'=>array('{:module}_{:controller}_{:action}_{goods_id}_{commentType}_{p}',TPSHOP_CACHE_TIME),  // 商品区评论页静态缓存 3秒钟        
        'Goods:ajax_consult'=>array('{:module}_{:controller}_{:action}_{goods_id}_{consult_type}_{p}',TPSHOP_CACHE_TIME),  // 商品区咨询页静态缓存 3秒钟                
        // 商品区详情的规格价格缓存在 ajaxGoodsPrice 函数里面 S($keys,$price,300);// 缓存数据300秒  
