...
//define('BUILD_CONTROLLER_LIST','Index,User,Menu,Goods,Nesws,Activity,Payment,Address,Cart,Login');
//define('BUILD_MODEL_LIST','User,Menu,Goods,User,Nesws,Address,Order');
// 引入ThinkPHP入口文件
