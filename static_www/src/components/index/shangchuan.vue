<template>
        ...
        <div class="upload_image_box" v-show="show1">
            <div class="upload_image">
                <div class="photo_box" @click="actionSheet()" >
                    <img class="icon_photo" src="@/assets/images/login/sc.png"  @click="tab()"/>
                    <p><span></span></p>
                </div>
            </div>
        </div>
        <div style="background: #f2f2f2; height: .5rem;"></div>
        <div class="uploaded" v-show="show2">
            <div v-for="(item,index) in imgLists" class="imgItem">
                <img @click="deleteImg(index)" class="delete" src="">
    ...
    <div style="position: relative;">
        <div class="nav_tc" style="display: none" >
        <p><a>获取照片</a></p>
            <p><a>拍照</a></p>
            <p><a>相册</a></p>
        <p style="padding-top: .2rem;"><a>取消</a></p>
        </div>
    </div>
    </div>
</template>
...
<style  scoped="scoped">
    .sc{ background-color: #fff; height: 14rem;}
        .upload_image_box{padding: .5rem;width: 100%;box-sizing: border-box;background: #fff;}
            .upload_image{background: #f2f2f2;width:100%;height: 3rem;border: 1px dashed #e6e6e6;/*no*/border-radius: 10px;}
                .photo_box{width: 100%;}
        ...
        .uploaded{width: 100%;box-sizing: border-box;background: #fff;}
            ...
            .imgUpload{width:100%;height:.5rem;display: inline-block;padding: .5rem;}
                .icon_photo{width: 1.3rem;height: 1.25rem;position: relative;left: 9%; top:1rem;}
                p{font-size: .24rem;/* px */color: #999999;text-align: center;margin: 0;}
    .imgUpload p{ background-color: #00a5ff;padding: .15rem 0;
        width: 100%;border-radius: 0.1rem;color: #fff;font-size: .28rem; }
