<template>
    <div>
        ...
        <yd-navbar bgcolor="#af773e" :fixed="true" >
            ...
            <p style="font-size: .3rem;color: #fff;" slot="center">账户明细</p>
        ...
        <div class="mui-content balance_record_container" style="padding-top: 1rem;">
            <div  class="bottom" id="log">
                <div id="item1" class="mui-control-content mui-active">
                    <!-- ================================================= -->
                    <div class="list" v-for="(item,key) in data" >
                        <div style="position: relative" class="top">
                            <div>{{ item.desc }}</div>
                            <div  style=" color: rgb(175, 119, 62); font-size: 0.45rem; position: absolute; right: .05rem; top: .2rem;">{{ item.user_money }}</div>
                        </div>
                        <div class="bottom">
                            <div>{{ item.change_time |time}}</div>
                            <div class="text"></div>
                        </div>
                    </div>
                </div>
    ...
    export  default{
        ...
        methods:{
            ...
            category () {
                ...
                var url = "/balance_detail?token=" + token;
