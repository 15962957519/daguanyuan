                ...
                <div class="margin_x"></div>
                        ...
                        <div class="order_o" v-for="item in payorderall">
                            ...
                            <div class="order_bottom">
                                <p v-if="item.pay_status == 0 && item.shipping_status == 0 && item.order_status == 0" v-on:click="orderDetail(item.order_id)">未付款</p>
